...
public class RdvController {
	...
	public RdvController(RdvI appointmentService, AppointmentOperation appointmentOperation) {
	...
	ResponseEntity<String> addAppointment(@RequestBody AppointmentAndUser appointmentAndUser) {
	   ...
	   ResponseEntity<List<RdvDto>> searchAppointmentByDate(@PathVariable("date") String date) throws ParseException
	   {
	   ...
	   ResponseEntity<List<RdvDto>> searchAppointmentByUser(@PathVariable("userName")String userName)
	   {
           try {
	   ...
	   ResponseEntity<List<RdvDto>> getListAppointment() {
		   try {
	   ...
	   @Transactional
	   void updateAppointment(@RequestBody RdvDto rdvDto) {
